...
export async function POST() {
  ...
  // Luôn gửi về email đang đăng nhập — đây là kiểm tra SMTP cho tài khoản của người dùng,
  // không phải thông báo nội bộ cho admin nền tảng (ADMIN_NOTIFY_EMAIL dùng ở chỗ khác).
