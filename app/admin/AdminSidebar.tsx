...
import { LayoutDashboard, Building2, Gift, DollarSign, Clock, ShieldCheck, LogOut, LifeBuoy, Target } from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/trust-layer", label: "Lớp tin cậy", icon: Target, exact: false },
