      ...
      <div className="w-full max-w-xs">
        <div className="mb-4">
          <GoogleIdentityButton
            ...
            fallbackClassName="w-full flex items-center justify-center gap-2.5 bg-white text-gray-700 font-semibold py-2.5 rounded-xl hover:bg-gray-50 transition-colors shadow-lg text-sm"
          />
        </div>
